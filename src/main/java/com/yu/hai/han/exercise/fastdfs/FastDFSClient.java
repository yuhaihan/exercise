...
/**
 * @ClassName: FastDFSClient2
 * @Description: TODO
 * @Author: Gavin
 * @Create: 2020-07-09 13:53
 * @Version: 1.0
 * @Copyright: 2018~2020-07-09 13:53 www.clisia.cn. 保留所有权利。
 * 版权所有： 中科空间信息（廊坊）研究院。
...
public class FastDFSClient {
     ...
     * @return 返回上传成功后的文件路径
     */
    public static String uploadFileWithFilepath(String filepath, Map<String, String> descriptions) throws FastDFSException {
     ...
     */
    public static String upload(String filepath, Map<String, String> descriptions) throws FastDFSException {
     ...
     * @return 文件描述信息
     */
    public static Map<String, Object> getFileDescriptions(String filepath) throws FastDFSException {
        TrackerServer trackerServer = TrackerServerPool.borrowObject();
        StorageClient1 storageClient = new StorageClient1(trackerServer, null);
        NameValuePair[] nvps = null;
        try {
    ...
    public static void main(String[] args) throws Exception {
        String pic = "C:\\Users\\yhhus\\Pictures\\身份证照片\\微信图片_20200427162731.jpg";
        try {
            String s = uploadFileWithFilepath(pic, new HashMap<>());
